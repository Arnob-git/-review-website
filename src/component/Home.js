      ...
      <sections className='d-flex align-items-center mt-lg-3'>
        <div className='row'>
          <div className='col-md-6 pt-5 pt-lg-0 order-2 order-md-1'>
            <h1>Welcome to <strong className='pulse'>Web Tech School</strong></h1>
